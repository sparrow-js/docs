...
**Wordix** is a tool that allows you to fastest generate a AI applications by executing document workflows.
...
The ability to provide a knowledge base and application development engine will be available soon.
...
- API access
- Self-hosting
- Possess an exclusive application

<Bleed>![wordix introduction](/introduction.png)</Bleed>
